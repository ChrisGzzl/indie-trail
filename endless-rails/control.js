...
// Normalize movement around the fixed stick center, independent of screen size.
...
const controlApi = { relativeCommand, directCommand, joystickVector, joystickCommand, createCommandRing, advanceCommandRing };
